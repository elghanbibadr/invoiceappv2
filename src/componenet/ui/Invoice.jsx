...
const Invoice = () => {
    return (
        <div className=' w-1/2  grid grid-cols-2 grid-rows-[1fr_30px_1fr] md:grid-cols-5 md:items-center md:grid-rows-1 md:h-fit  bg-primaryColor p-6 rounded-md cursor-pointer hover:border border-paleCyan '>
